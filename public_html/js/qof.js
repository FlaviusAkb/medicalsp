...
function singleFileValidation(jInfo) {
  ...
  jInfo.mandatoryFile = jInfo.mandatoryFile == undefined ? 1 : jInfo.mandatoryFile;
...
function searchField(subject) {
  ...
  srcEl.map((i, element) => {
    if ($(element).html().toLowerCase().includes(subject.val().trim().toLowerCase())) {
...
class dialog {
  ...
  defaultSettings(defaultSettings = {}) {
    defaultSettings.closeAction = defaultSettings.hasOwnProperty("closeAction") ? defaultSettings.closeAction : () => {};
    defaultSettings.id = defaultSettings.hasOwnProperty("id") ? defaultSettings.id : `dia` + (new Date().getTime() + "" + Math.floor(Math.random() * (10 - 1 + 1)) + 1);
    defaultSettings.showByDefault = defaultSettings.hasOwnProperty("showByDefault") ? defaultSettings.showByDefault : 1;

    defaultSettings.title = defaultSettings.hasOwnProperty("title") ? defaultSettings.title : "";

    return defaultSettings;
  }
  defaultStyle(defaultStyle = {}) {
    defaultStyle.extraCss = defaultStyle.hasOwnProperty("extraCss") ? defaultStyle.extraCss : "";
    // STYLE SETTINGS
    //EI - EXTRA INFO ( like css settings and so on )

    defaultStyle.cMain = defaultStyle.hasOwnProperty("cMain") ? defaultStyle.cMain : "";

    defaultStyle.aLower = defaultStyle.hasOwnProperty("aLower") ? defaultStyle.aLower : "";
    defaultStyle.mUpper = defaultStyle.hasOwnProperty("mUpper") ? defaultStyle.mUpper : "";
    defaultStyle.eUpper = defaultStyle.hasOwnProperty("eUpper") ? defaultStyle.eUpper : "";
    defaultStyle.mContent = defaultStyle.hasOwnProperty("mContent") ? defaultStyle.mContent : "";
    // size settings
    defaultStyle.width = defaultStyle.hasOwnProperty("width") ? defaultStyle.width : "1160px";
    defaultStyle.tExtraCss = defaultStyle.hasOwnProperty("tExtraCss") ? defaultStyle.tExtraCss : "";
    defaultStyle.DBExtraCss = defaultStyle.hasOwnProperty("DBExtraCss") ? defaultStyle.DBExtraCss : "";

    // timer and closing functions
    defaultStyle.timer = defaultStyle.hasOwnProperty("timer") ? defaultStyle.timer : 0;
    defaultStyle.duration = defaultStyle.hasOwnProperty("duration") ? defaultStyle.duration : 0;
    defaultStyle.hideX = defaultStyle.hasOwnProperty("hideX") ? defaultStyle.hideX : 0;
    defaultStyle.xBG = defaultStyle.hasOwnProperty("xBG") ? defaultStyle.xBG : "black";

    // bind triggers for external uses
    defaultStyle.customTrigger = defaultStyle.hasOwnProperty("customTrigger") ? defaultStyle.customTrigger : "";

    //title settings
    defaultStyle.tColor = defaultStyle.hasOwnProperty("tColor") ? defaultStyle.tColor : "black";

    // body settings
    defaultStyle.borderRadiusBod = defaultStyle.hasOwnProperty("borderRadiusBody") ? defaultStyle.borderRadiusBod : "8px";
    defaultStyle.paddingBod = defaultStyle.hasOwnProperty("paddingBod") ? defaultStyle.paddingBod : "16px";
    defaultStyle.bgColor = defaultStyle.hasOwnProperty("bgColor") ? defaultStyle.bgColor : "#272727";
    defaultStyle.dropShadow = defaultStyle.hasOwnProperty("dropShadow") ? defaultStyle.dropShadow : "0 0.5rem 1rem rgba(0, 0, 0, 0.15)";
    ...
    defaultStyle.paddingActions = defaultStyle.hasOwnProperty("paddingActions") ? defaultStyle.paddingActions : "8px";

    //scrollbar
    defaultStyle.trackBG = defaultStyle.hasOwnProperty("trackBG") ? defaultStyle.trackBG : "rgba(0,0,0,0)";
    defaultStyle.thumbBG = defaultStyle.hasOwnProperty("thumbBG") ? defaultStyle.thumbBG : "#4d4d4d";
...
document.addEventListener("DOMContentLoaded", () => {
  $(".flyout-content").parent().append('<span class="has_submenu"><i class="fas fa-plus"></i></span>');
  $(".flyout-content2").parent().append('<span class="has_submenu"><i class="fas fa-plus"></i></span>');
