            ...
            $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.includes("success")) {
                                errors.alertBody({
                                    body: "Widget saved successfully!",
                                    style: "info",
                                    closeDuration: 10,
                                });
                                loadWidgets();
                ...
                $(document).on("click", ".edit-btn", function() {
                    ...
                    $.ajax({
                        ...
                        error: function() {
                            errors.alertBody({
                                body: "Error fetching widget details..",
                                style: "error",
                                closeDuration: 10,
                            });
                        },
                ...
                $(document).on("click", ".delete-btn", function() {
                    ...
                    if (confirm("Are you sure you want to delete this widget?")) {
                        $.ajax({
                            ...
                            success: function() {
                                errors.alertBody({
                                    body: "Widget deleted succesfully!",
                                    style: "info",
                                    closeDuration: 10,
                                });
                                loadWidgets();
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (data.status === 'success') {
                            errors.alertBody({
                                body: "Widgets reordered successfully!",
                                style: "info",
                                closeDuration: 10,
                            });
                            loadWidgets();
